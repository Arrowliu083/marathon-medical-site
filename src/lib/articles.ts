...
export const articles: ArticleMeta[] = [
  ...
  {
    slug: 'why-300m-first-aider',
    title: '标准为何要求300米一个急救员',
    titleEn: 'Why the Standard Requires a First Aider Every 300 Meters',
    author: '廖育鲲',
    authorRole: '标准起草专家 / 世界田联REMC医疗官',
    date: '2026-05-24',
    category: 'standards',
    summary: '深入解读T/CADERM 8001-2021中"现场急救人员相隔不超过300m"规定的背后逻辑——从心脏骤停黄金四分钟、热急症并发风险到急救员与观察志愿者的区别，全面阐释这一核心配置要求的科学依据。',
